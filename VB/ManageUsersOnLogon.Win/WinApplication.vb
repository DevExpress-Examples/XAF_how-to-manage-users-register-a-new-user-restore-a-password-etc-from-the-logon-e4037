...
Namespace ManageUsersOnLogon.Win
	Partial Public Class ManageUsersOnLogonWindowsFormsApplication
		...
		End Sub
		Private Sub ManageUsersOnLogonWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
...
#End If
		End Sub
		Private Sub ManageUsersOnLogonWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
